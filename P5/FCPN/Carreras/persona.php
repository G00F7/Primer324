    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-50">
        <div class="section-info">
          ...
          <a href="../Carreras/tabla.php ? ci=<?php echo $CIusuario;?>&user=<?php echo $usuario;?>&rol=<?php echo $IDrol;?>&carrera=<?php echo $carrera;?>" class="anchor-btn"  >Ver Notas <i class="fas fa-arrow-right pd-lt-10"></i></a> </div>
      </div>
      <div class="col-md-6 mb-50">
      </div>
    </div>
