...
<nav class="navbar navbar-expand-lg">
  <div class="container"> <a class="navbar-brand navbar-logo" href="#"> <img src="../../images/logo-white-fis.png" alt="logo" class="logo-1"> </a>
...
<div class="banner text-center" data-scroll-index='0'>
  <div class="banner-overlay">
    <div class="container">
      <h1 class="text-capitalize">Carrera de Física</h1>
...
<script>
  $(window).on("scroll",function () {
      ...
      if(bodyScroll > 130){
          ...
          $('.navbar-logo img').attr('src','../../images/logo-black-fis.png');
      }else{
          navbar.removeClass("nav-scroll");
          $('.navbar-logo img').attr('src','../../images/logo-white-fis.png ');
      }
  });
